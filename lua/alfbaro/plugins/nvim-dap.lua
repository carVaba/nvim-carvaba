...
return {
    ...
    config = function()
        ...
        local codelldbPath = os.getenv("HOME") .. "/Developer/codelldb-darwin-arm64/extension/adapter/codelldb"
        ...
        require("dap").adapters.lldb = {
            ...
            port = 13000,
            executable = {
                command = os.getenv("HOME") .. "/Developer/codelldb-darwin-arm64/extension/adapter/codelldb",
                args = { "--port", "13000" },
            },
        }
